 ...
 * @author Igor Morenko <morenko at lionsoft.ru>
 */
public class EntityFactoryProxy {
    ...
    public static EntityFactoryProxy getInstance() {
        return EntityFactoryHolder.INSTANCE;
    }
    
    private static class EntityFactoryHolder {

        private static final EntityFactoryProxy INSTANCE = new EntityFactoryProxy();
    }
